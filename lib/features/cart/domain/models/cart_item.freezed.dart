...
class _$CartItemImpl implements _CartItem {
  ...
  @override
  String toString() {
    return 'CartItem(dishId: $dishId, name: $name, unitPrice: $unitPrice, quantity: $quantity, imageUrl: $imageUrl, allergens: $allergens, isAvailable: $isAvailable, prepTimeMin: $prepTimeMin)';
  }
